      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-6 text-gray-600">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-700 mb-3">第4条（禁止事項）</h2>
